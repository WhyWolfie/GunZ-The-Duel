...
if(isset($_POST['submit'])){
    ...
    mssql_query_logged("INSERT INTO ShopSetsdon ([Name], [Level], [Price], [Sex], [ImageURL], [HeadItemID], [ChestItemID], [HandItemID], [LegItemID], [FeetItemID])VALUES('$nombre', '$level', '$price', '$sex', '$img', '$cabeza', '$pecho', '$mano', '$pierna', '$pies')");
    	
	msgbox("Su Donator Set Fue agregado con exito.","index.php?do=additem5");
}else{
?>
<style type="text/css">
<!--
...
<body bgcolor="#323232">
<form method="POST" action="index.php?do=additem5">
