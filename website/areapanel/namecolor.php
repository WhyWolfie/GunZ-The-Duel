...
<form name="ban" method="POST" action="index.php?do=namecolor"><table border="1" style="border-collapse: collapse" width="454" height="100%">
										...
										UserID
                                          ...
                                          <option value="<? echo $_COLORUGRA_3 ?>"><? echo $_UGRADENAME_3 ?> </option>
                                          <option value="<? echo $_COLORUGRA_4 ?>"><? echo $_UGRADENAME_4 ?></option>
                                          <option value="<? echo $_COLORUGRA_5 ?>"><? echo $_UGRADENAME_5 ?></option>			                                          <option value="<? echo $_COLORUGRA_4 ?>"><? echo $_UGRADENAME_4 ?></option>
