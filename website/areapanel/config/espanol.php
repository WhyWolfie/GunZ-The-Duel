...
$_STR[Login5]   = "Tu cuenta no tiene permiso para acceder al panel de administracion";
$_STR[Login6]   = "UserID O Password Incorrecto";

// SACKER s4cker@hotmail.com
$_STR[SACKER0]    = "Menú del Panel";
...
$_STR[SACKER32]    = "Shop GameMaster";
$_STR[SACKER60]    = "Agregar Set Donator";
$_STR[SACKER61]    = "Agregar Set Event";
// Sistema de Mensajes
$_STR[Msg0]     = "Mensaje de: AuraGamers";
$_STR[Msg1]     = "Debes llenar todos los campos";

// Formulario Login
$_STR[Login0]   = "Login Staff";
$_STR[Login1]   = "UserID";
...
// Inicio
$_STR[Home0]    = "Bienvenido al Panel De AuraGunz";
$_STR[Home1]    = "Puedes Visitarnos en Nuestro Foro";
$_STR[Home2]    = "<center>Estado Del Servidor</center>";
...
$_STR[Acc2]     = "Cambiar";
$_STR[Acc3]     = "Cambiar Pasword";
$_STR[Acc4]     = "Nueva Pasword";
$_STR[Acc5]     = "Cambiar Permiso";
$_STR[Acc6]     = "Baneado";
$_STR[Acc7]     = "Usuario";
$_STR[Acc8]     = "Moderador Invisible";
$_STR[Acc9]     = "Desarrollador";
$_STR[Acc10]    = "Administrador";
$_STR[Acc11]    = "Enviar item al storage de TODAS las cuentas";
$_STR[Acc12]    = "Duracion(Dias)";
