...
<body bgcolor="#323232">
                    ...
                    <div align="center">
                        <table border="1" style="border-collapse: collapse" width="461" height="100%">
                                        <tr>
                                          <td colspan="2">Enviar AG Coins (Sirve para comprar items Normales)</td>
                                      </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td><select size="1" name="Coins" id="Coins">
						                              <option value="10" selected>10 AG Coins</option>
                                                      <option value="40">40 AG Coins</option>
                                                      <option value="100">60 AG Coins</option>
                                                      <option value="150">150 AG Coins</option>
                                                      <option value="200">200 AG Coins</option>
                                                      <option value="250">250 AG Coins</option>
                                                      <option value="300">300 AG Coins</option>
                                                      <option value="350">350 AG Coins</option>
                                                      <option value="400">400 AG Coins</option>
                                                      <option value="450">450 AG Coins</option>
                                                      <option value="500">500 AG Coins</option>
                                                      <option value="1000">1000 AG Coins</option>
                                                      <option value="2000">2000 AG Coins</option>
                                                      <option value="100000">100000 AG Coins</option>
                                                      <option value="200000">200000 AG Coins</option>
											</select></td>
                                      </tr>
                                        <tr>
