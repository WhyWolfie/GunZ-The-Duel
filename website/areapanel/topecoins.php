<?php
	...
	?>
<?php
$query = mssql_query("SELECT * FROM Account order by EventCoins DESC");
...
<table width="646" border="1">
  ...
  <tr>
    ...
    <td width="61"><span class="style29"><strong>Coins</strong></span></td>
    <td width="56"><span class="style29"><strong>ECoins</strong></span></td>
    <td width="64"><span class="style28"><strong>DCoins</strong></span></td>
...
$rank = $i+1;
  ...
  <tr>
    ...
    <td><span class="style29"><?php echo "$row[24]";?></span></td>
    <td><span class="style28"><?php echo "$row[25]";?></span></td>
