...
if(isset($_POST['submit'])){
    ...
    mssql_query_logged("INSERT INTO ShopItems ([Name], [Slot], [zItemID], [Sex], [ImageURL], [Level], [Weight], [Price], [Delay], [Damage], [Magazine], [ReloadTime], [MaxBullet], [HP], [AP], [MaxWeight], [Control], [FR], [PR], [CR], [LR], [Duration])VALUES('$nombre', '$slot', '$iditem', '$sex', '$img', '$level', '$peso', '$price', '$delay', '$damage', '$magazine', '$reloadtime', '$maxbalas', '$hp', '$ap', '$maxpeso', '$control', '$FR', '$PR', '$CR', '$LR', '$dura')");
	mssql_query("INSERT INTO Item ([ItemID], [Name], [ResSex]) VALUES ('$iditem', '$nombre', '$sex')");
     msgbox("Su Item fue agregado con exito!!!!^^ By Sacker","index.php?do=additem");
}else{
?>
<style type="text/css">
<!--
...
<!-- Coding By Sacker - GodOfWar -->
										<tr>
											<td colspan="3">Agrega Items Normales By SackerZ                                            </td>
										...
										<tr>
											...
											<option selected value="1">Armas</option>
...
<!-- Coding By Sacker - GodOfWar -->
										...
										<tr>
                                          ...
                                          <input type="submit" value="Agregar Item Normal" name="submit">
                                          </span>
