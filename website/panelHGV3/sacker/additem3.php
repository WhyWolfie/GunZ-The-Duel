...
if(isset($_POST['submit'])){
    ...
    mssql_query_logged("INSERT INTO ShopDonator ([Name], [zItemID], [Sex], [ImageURL], [Level], [Weight], [Price], [Delay], [Damage], [Magazine], [ReloadTime], [MaxBullet], [HP], [AP], [MaxWeight], [Control], [FR], [PR], [CR], [LR], [Duration])VALUES('$nombre', '$iditem', '$sex', '$img', '$level', '$peso', '$price', '$delay', '$damage', '$magazine', '$reloadtime', '$maxbalas', '$hp', '$ap', '$maxpeso', '$control', '$FR', '$PR', '$CR', '$LR', '$dura')");
	mssql_query("INSERT INTO Item ([ItemID], [Name], [ResSex]) VALUES ('$iditem', '$nombre', '$sex')");
    
	
	msgbox("Su Item Donante fue agregado con exito!!!!^^ By Sacker","index.php?do=additem3");
}else{
?>
<style type="text/css">
<!--
...
<body bgcolor="#323232">
<form method="POST" action="index.php?do=additem3">
<table border="1" style="border-collapse: collapse" width="585" height="100%">
<!-- Coding By Sacker - GodOfWar -->
										<tr>
											<td colspan="3">Agrega Items Donator By SackerZ
                                            </td>
										</tr>
										...
										<tr>
											...
											<td width="330">
											  <p>
										    &quot; images/shop/
                                            <input type="text" name="img" size="34" value="imagen.gif">
											  </p></td>
										</tr>
...
<!-- Coding By Sacker - GodOfWar -->
										...
										<tr>
                                          ...
                                          <input type="submit" value="Agregar Item Donator" name="submit">
                                          </span>
