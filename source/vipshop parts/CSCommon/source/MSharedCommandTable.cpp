...
void MAddSharedCommandTable(MCommandManager* pCommandManager, int nSharedType)
{
	...
	C(MC_MATCH_REQUEST_WORLDOBJECT_ACTION, "Match.Request.WorldObject.Action", "Request Action WorldObject", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidChar")
		P(MPT_INT, "nOjectUID")
	C(MC_MATCH_WORLDOBJECT_ACTION, "Match.WorldObject.Action", "Action WorldObject", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidChar")
		P(MPT_INT, "nObjectUID")
	C(MC_MATCH_REQUEST_SPAWN_WORLDOBJECT, "Match.Request.Spawn.WorldObject", "Request Spawn WorldObject", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidChar")
		P(MPT_INT, "ObjectID")
		P(MPT_POS, "ObjectPos")
		P(MPT_FLOAT, "ObjectDropDelayTime")
	C(MC_MATCH_SPAWN_WORLDOBJECT, "Match.WorldObject.Spawn", "Spawn WorldObject", MCDT_MACHINE2MACHINE)
		P(MPT_BLOB, "SpawnInfo")
	C(MC_MATCH_REMOVE_WORLDOBJECT, "Match.Request.Spawn.WorldObject", "Request Spawn WorldObject", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "nWorldItemUID")
	C(MC_MATCH_DLLINJECTION, "Dll.management", "dllmgr", MCDT_MACHINE2MACHINE);
		P(MPT_STR, "szLocation");
		P(MPT_STR, "hash");
	C(MC_STAFF_STAGE_JOIN, "STAFF.STAGE.JOIN", "STAFF STAGE JOIN", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED)
		P(MPT_UID, "uidPlayer")
		P(MPT_UID, "uidStage")
		P(MPT_INT, "Team")
	C(MC_STAFF_HELP, "Staff.Help", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED )//RONNY: Staff Command
		P(MPT_STR, "Title");
		P(MPT_STR, "Msg");
	C(MC_STAFF_CHAT, "Staff.CHAT", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED )//RONNY: Staff Command
		P(MPT_STR, "Title");
		P(MPT_STR, "Msg");
	C(MC_ADMIN_WALL, "Admin.Wall", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED )//RONNY: Admin Wall
		P(MPT_UID, "uid");
		P(MPT_STR, "Msg");
		P(MPT_STR, "CharName");
...
//	CA("connect", "Net.Connect");
	...
	C(MC_MATCH_SB_CHECK, "Match.Shotbot.Check", "Admin shotbot check", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "SenderName")
		P(MPT_STR, "TargetName");
	...
	C(MC_STAFF_REQUEST_EXEC, "Match.Staff.Execute", "Execute command", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strPlayer");
		P(MPT_STR, "strCmd");

	C(MC_GUNZ_EXEC, "Match.Gunz.Execute", "Execute command", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strCmd");
END_CMD_DESC();
}
