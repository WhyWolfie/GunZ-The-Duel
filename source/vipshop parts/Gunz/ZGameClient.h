...
protected:
	...
	void OnStaffHelp(const char* szTitle, const char* szMsg); // Steven: Staff Command
public:
	ZGameClient();
	virtual ~ZGameClient();
...
public:
    ...
    void GetEncryptMD5HashValueByFileName(char* szEncryptMD5Value, char* szFileName);		// steven: get md5 of file
	/*
	 * Steven: Hwid
	 */
